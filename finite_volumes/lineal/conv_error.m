...
% Mallado del tiempo
dt = [5e-5, 1e-5, 5e-6];      % subintervalos de tiempo
t_max = 0.003;     % tiempo máximo de integracion
...
%Calculo del orden de convergencia numericamente
[k]=polyfit(log(dx),log(error),1);
disp(['El orden de convergencia del metodo de Godunov es de orden  ', num2str(k(1))])
% Reprresentacion del error
figure
